...
int main()
{
    ...
    // --------------------
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "PBR DEMO2", NULL, NULL);
    ...
    // -------------------------
    Shader pbrShader("shader/pbr_2.vs", "shader/pbr_2.fs");
    ...
    float* data = stbi_loadf("textures/newport_loft_Ref.hdr", &width, &height, &nrComponents, 0);
